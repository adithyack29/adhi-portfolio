            ...
            `}
                    ...
                    >
                        {childrenNodes.map((child, index) => {
                            ...
                            let xVal = currentRadius * Math.cos(angle);
                            const yVal = currentRadius * Math.sin(angle);
                            ...
                            // Fix hydration mismatch by ensuring deterministic string output
                            const xStr = xVal.toFixed(3);
                            const yStr = yVal.toFixed(3);
                            const rotStr = (rotationAngle + 90).toFixed(2);
                            ...
                            return (
                                <li
                                    ...
                                    style={{
                                        ...
                                        transform: `translate(-50%, -50%) translate3d(${xStr}px, ${yStr}px, 0px) rotate(${rotStr}deg)`,
                                    }}
                                >
                                    {/* 
