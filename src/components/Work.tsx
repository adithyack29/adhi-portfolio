...
import { MobileProjectGallery } from '@/components/ui/mobile-project-gallery';
    ...
    return (
        <section id="work" className="bg-black text-white min-h-screen py-0 relative">
            <div className="py-24 flex flex-col items-center">
                ...
                <div className="hidden md:block text-center text-gray-500 mb-8 animate-bounce uppercase tracking-widest text-xs">
                    ↓ Scroll to Rotate
                </div>
                <div className="block md:hidden text-center text-gray-500 mb-8 animate-bounce uppercase tracking-widest text-xs">
                    ↓ Scroll to Explore
                </div>
            </div>
            ...
            <div className="block md:hidden w-full">
                <MobileProjectGallery projects={projects} onProjectSelect={setSelectedProject} />
            </div>

            {/* Desktop View: Radial Scroll - Hidden on mobile */}
            <div className="hidden md:block w-full">
                <RadialScrollGallery className="w-full"
                    baseRadius={500}
                    mobileRadius={180}
